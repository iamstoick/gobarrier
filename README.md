# gobarrier
A high-performance, cross-platform KVM software switch written in Go — inspired by [Barrier](https://github.com/debauchee/barrier) but rebuilt for lower latency and with drag-and-drop file transfer between machines.
